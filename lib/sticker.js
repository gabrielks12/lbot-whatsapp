...
module.exports = {
    ...
    textoParaFoto: async(texto)=>{
        try{
            var res =  await axios.get(encodeURI(`https://testebot.onrender.com/ttp?texto=${texto}&cor=FFA500`),
             {
                responseType: "text",
    ...
    textoParaGif: async(texto)=>{
        try{
            var res =  await axios.get(encodeURI(`https://testebot.onrender.com/attp?texto=${texto}`))
